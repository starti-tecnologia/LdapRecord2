...
class Ldap
{
  ...
  public function search($dn, $filter, array $fields, $onlyAttributes = false, $size = 0, $time = 0, $deref = null, $serverControls = [])
  {
    ...
    $args = array_merge([$this->connection], func_get_args());
   ...
   * @return bool
   */
  public function controlPagedResult($pageSize = 5000, $isCritical = false, $cookie = '')
  {
    $args = [$this->connection, $pageSize, $isCritical, $cookie];
  ...
  {
    $args = [$this->connection, $result, &$cookie];
    return call_user_func_array('ldap_control_paged_result_response', $args);/*
